...
| S1 | `state/intake/intake-NNN.md`, `docs/vision.md`, `docs/ROADMAP-001.md`, `docs/USE_CASES.md`, `docs/PROGRESS.md` | `src/`, `tests/`, `docs/architecture/containers.md`, `docs/DECISIONS.md` |
