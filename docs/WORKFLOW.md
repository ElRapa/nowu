...
|-------|------|------------|
| nowu-intake | `intake-NNN.md`, `vision.md`, `ROADMAP.md`, `USE_CASES.md` | `src/`, `tests/`, `docs/architecture/containers.md`, `DECISIONS.md` |
...
| nowu-shaper | `decision handoff`, file tree, `contracts/`, test structure, `ROADMAP.md` | `docs/architecture/containers.md`, `DECISIONS.md`, vision |
...
| nowu-curator | `review report`, `DECISIONS.md`, `ROADMAP.md`, `intake-NNN.md`, `git log` | `src/`, `tests/` |
