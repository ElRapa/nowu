...
- Then roughly every 2–4 weeks, or when `docs/ROADMAP-004.md` changes stage.
...
- `docs/ROADMAP-004.md`         # current stage / version plan (if missing, treat as PLAN-ABSENT)

Optional (load if they exist):

- `docs/USE_CASES.md`       # existing UC catalog
- `docs/ROADMAP-004.md`        # where current effort sits on the plan
...
1. **Classify product stage**
    - Read `docs/ROADMAP-004.md` and `docs/ROADMAP-004.md` (if present).
