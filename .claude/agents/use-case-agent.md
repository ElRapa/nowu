...
- Then roughly every 2–4 weeks, or when `docs/ROADMAP.md` changes stage.
...
- `docs/ROADMAP.md`         # current stage / version plan (if missing, treat as PLAN-ABSENT)

Optional (load if they exist):

- `docs/USE_CASES.md`       # existing UC catalog
- `docs/ROADMAP.md`        # where current effort sits on the plan
...
1. **Classify product stage**
    - Read `docs/ROADMAP.md` and `docs/ROADMAP.md` (if present).
